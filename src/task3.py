...
# Save result
sentiment_stats.coalesce(1).write.mode("overwrite").csv("/workspaces/handson-8-spark-sql-and-dataframes-polamsrija1/outputs/sentiment_engagement.csv", header=True)
